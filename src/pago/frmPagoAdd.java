        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkVerificado, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE))
                .addGap(79, 79, 79))
        );
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtTotalDeuda)
                            .addComponent(btnVerPagos, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnVerFactura, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE))))
                .addContainerGap())
        );
...
private void btnGuardarPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarPagoActionPerformed
    ...
    else
    {
        ...
        {*/
            //INSERTAR PAGO
            objPago.insertarRegistroReciboCobro(main.idUser, factRef, 
                    ""+objUtils.redondear(valor), idCajaAbierta,
                    txtReciboDePago.getText(), codigoCliente, "N", "1", "N");
            ...
            //AUDITORIA
            objAuditoria.insertarAuditoria("frmPagoAdd", "INGRESO DEL PAGO POR LA  CUENTA: "+txtIdCuentaCobrar.getText() +"-"+txtDescripcion.getText().toString(), "3");
            //dispose();
            txtValor.setText("");
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    frmListClientes ventana = new frmListClientes(null, true, "9");
  ...
  ArrayList<clsCliente> dataCliente = objCliente.consultarDataCliente(txtCedula.getText().toString());
    ...
    void llenarTablaDeudas()
    {
        ...
        else
        {
            ...
            for(int i=0;i<maxDataFact;i++)
            {
                 valor = Double.parseDouble(dataCtasCobrarFact.get(i).getValor());
                 valorActual = Double.parseDouble(dataCtasCobrarFact.get(i).getValorActual());

                 Object[] nuevaFila = {i+1, 
                                        dataCtasCobrarFact.get(i).getFactReferencia(), 
                                        dataCtasCobrarFact.get(i).getDescripcion(), 
                                        objUtils.redondear(valor), 
                                        objUtils.redondear(valorActual),
                                        dataCtasCobrarFact.get(i).getIdCtaCobrar(),
                                        dataCtasCobrarFact.get(i).getIdCabeceraMovi(),
                                        "FACTURA"};
                 dtmData.addRow(nuevaFila); 
                 totalDeudas = totalDeudas + valorActual;
            }   
