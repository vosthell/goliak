 ...
 * @author User
 */
public class frmPagoDetalle extends javax.swing.JInternalFrame {
    ...
    public frmPagoDetalle(int idPago) {
        idPago_publica = idPago;
        initComponents();
        ArrayList<clsPago> dataPago = objPago.consultaDataPagoDetalle(idPago);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmPagoDetalle.class);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    PrintWriter pw = null;
    ArrayList<clsPago> dataPago = objPago.consultaDataPagoDetalle(idPago_publica);
    try
    {
        ...
        dataPago = objPago.consultaDataPagoDetalle(idPago_publica);
        //RESTAR SALDO
        //ACTUALIZAR SALDO
...
private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
    if(objPago.eliminarPago(idPago_publica))
