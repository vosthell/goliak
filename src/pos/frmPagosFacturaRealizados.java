 ...
 * @author CKaiser
 */
public class frmPagosFacturaRealizados extends javax.swing.JInternalFrame {
    ...
    public frmPagosFacturaRealizados() {
        initComponents();
        Double total = 0.00;
        ...
        ArrayList<clsPago> dataPagos = objPago.consultaPagosFacturaRealizadas(idCajaAbierta); 
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmPagosFacturaRealizados.class);
