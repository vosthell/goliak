 ...
 * @author CKaiser
 */
public class frmRecibosPagoGenerados extends javax.swing.JInternalFrame {
    ...
    public frmRecibosPagoGenerados() {
        ...
        ArrayList<clsPago> dataRecibo = objPago.consultaRecibosGenerados(idCajaAbierta); 
        int maxData = dataRecibo.size();
        DecimalFormat df1 = new DecimalFormat("###0.00"); 
        for(int i=0;i<maxData;i++)
        {
             Object[] nuevaFila = {i+1, 
                                    dataRecibo.get(i).getCodigoRecibo(),
                                    dataRecibo.get(i).getReferencia(),
                                    dataRecibo.get(i).getFechaPago().substring(0, 16),
                                    df1.format(dataRecibo.get(i).getValor())
             };       
             total = total + dataRecibo.get(i).getValor();
             dtmData.addRow(nuevaFila); 
        } 
        txtTotal.setText(df1.format(total));
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmRecibosPagoGenerados.class);
