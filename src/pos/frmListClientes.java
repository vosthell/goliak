...
public class frmListClientes extends javax.swing.JDialog {
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
        ...
        if ((fila > -1) && (columna >-1)) 
        {
           ...
           {
                frmDevolucionVenta.codigoCliente = Integer.parseInt(codigo);
                frmDevolucionVenta.txtCedula.setText(cedula);
                frmDevolucionVenta.txtNombreCliente.setText(nombre);
           }
           else if(p_tipo.equals("7"))
           {
                frmNotasEntrega1.codigoCliente = Integer.parseInt(codigo);
                frmNotasEntrega1.txtCedula.setText(cedula);
                frmNotasEntrega1.txtNombreCliente.setText(nombre);
           }
           else if(p_tipo.equals("8"))
           {
                frmEstadoDeCuenta.codigoCliente = codigo;
                frmEstadoDeCuenta.txtCedula.setText(cedula);
                frmEstadoDeCuenta.txtNombreCliente.setText(nombre);                 
           }
           else if(p_tipo.equals("9"))
           {
                frmPagoAdd.codigoCliente = codigo;
                frmPagoAdd.txtCedula.setText(cedula);
                frmPagoAdd.txtNombreCliente.setText(nombre);                 
           }
           else if(p_tipo.equals("10"))
           {
               frmClienteIncobrable.txtCedula.setText(cedula);
           }  
           else if(p_tipo.equals("11"))
           {
               frmListNotasEntrega.txtCedula.setText(cedula);
           } 
           else if(p_tipo.equals("12"))
           {
                frmNotasEntregaModificar.codigoCliente = Integer.parseInt(codigo);
                frmNotasEntregaModificar.txtCedula.setText(cedula);
                frmNotasEntregaModificar.txtNombreCliente.setText(nombre);
           }
           else if(p_tipo.equals("13"))
           {
                frmPagoAddOtros.codigoCliente = codigo;
                frmPagoAddOtros.txtCedula.setText(cedula);
                frmPagoAddOtros.txtNombreCliente.setText(nombre);                 
           }
