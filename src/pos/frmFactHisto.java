...
public class frmFactHisto extends javax.swing.JInternalFrame {
    ...
    public frmFactHisto() {
        //super(parent, modal);
        initComponents();  
        this.setTitle(objUtils.nombreSistema + "Facturar lo que habia de deudas en Monica");
...
private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        else
        {
            ...
            if(exito)
            {
                ...
                {                          
                    ...
                    //AUDITORIA
                    objAuditoria.insertarAuditoria("frmFactHisto", "INGRESO DEL NOTA DE ENTREGA MONICA: " + ultmFactura + "-" + this.txtComentario.getText().toString() + ", VALOR: " + this.txtEfectivo.getText().toString(), "3");
                    /*VACIAR DATOS*/
                    txtNombreProducto.setText("");
                    cmbPrecio.removeAllItems();
                    txtCodigoProducto.setText("");
                ...
                catch(Exception e)
                {
                    System.out.println(e.getMessage());
                     //AUDITORIA
                    objAuditoria.insertarAuditoria("frmFactHisto", "ERROR - INGRESO DE LA NOTA DE ENTREGA MONICA: " + ultmFactura + "-" + this.txtComentario.getText().toString() + ", VALOR: " + this.txtEfectivo.getText().toString(), "3");
    ...
    private void btnMostrarProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarProductosActionPerformed
        frmListProductos ventana = new frmListProductos(null, true, "2", "N");        
        ventana.setLocationRelativeTo(null);
        ventana.setVisible(true);
