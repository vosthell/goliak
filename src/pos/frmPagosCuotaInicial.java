...
/*
 * frmPagosCuotaInicial.java
 *
 * Created on 23/03/2013, 04:20:49 PM
 */
package pos;
 ...
 * @author User
 */
public class frmPagosCuotaInicial extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmPagosCuotaInicial.class);
...
private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
    ...
    objPago.asignarPago(idCabeceraMovi, idPago);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPagosCuotaInicial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
