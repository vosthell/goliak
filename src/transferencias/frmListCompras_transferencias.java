...
import producto.frmComprasRecibir;
 ...
 * @author CKaiser
 */
public class frmListCompras_transferencias extends javax.swing.JInternalFrame {
    ...
    public frmListCompras_transferencias() {
        initComponents();        
        ...
        ArrayList<clsCompras> dataCompras = objCompras.consultaDataComprasTransferencia(); 
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmListCompras_transferencias.class);
...
private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
    ...
    {   
        frmComprasShow_transferencia formulario = new frmComprasShow_transferencia(idCabecera);
...
private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
    ...
    public void buscar_informacion()
    {
        ...
        if(this.chkFechaRegistro.isSelected())
        {
            ...
            //Integer.parseInt(objEmpresaSelect.getCodigo())
            ArrayList<clsCompras> dataCompras = objCompras.consultaDataComprasRangoRegistro_transferencia(fechaInicio, fechaFin, soloProveedor, objEmpresaSelect.getCodigo()); 
            llenarData(dataCompras);
        }
        else if(this.chkFechaRecibe.isSelected())
        {
            ...
            ArrayList<clsCompras> dataCompras = objCompras.consultaDataComprasRangoRecibe_transferencia(fechaInicio, fechaFin, soloProveedor, objEmpresaSelect.getCodigo()); 
            llenarData(dataCompras);
        }
        else
        {
            ArrayList<clsCompras> dataCompras = objCompras.consultaDataComprasProv_transferencia(soloProveedor, objEmpresaSelect.getCodigo()); 
            llenarData(dataCompras);    
        }
    }        
