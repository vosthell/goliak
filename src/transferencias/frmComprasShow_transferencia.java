 ...
 * @author CKaiser
 */
public class frmComprasShow_transferencia extends javax.swing.JInternalFrame {
    ...
    public frmComprasShow_transferencia(int idCabecera) {
        initComponents();
        
        DecimalFormat df1 = new DecimalFormat("###0.00"); 
        txtCodigoFactura.setText(""+ idCabecera);
        ArrayList <clsCompras> dataCompra = objCompras.consultarDataCompraTransferencia(idCabecera);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmComprasShow_transferencia.class);
