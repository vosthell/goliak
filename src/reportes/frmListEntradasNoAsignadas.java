 ...
 * @author CKaiser
 */
public final class frmListEntradasNoAsignadas extends javax.swing.JInternalFrame {
    ...
    public frmListEntradasNoAsignadas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stinventario.STInventarioApp.class).getContext().getResourceMap(frmListEntradasNoAsignadas.class);
    ...
    public void buscar_informacion()
    {
        ...
        ArrayList<clsPago> dataPago = objPago.consulta_entradas_no_asignadas(); 
